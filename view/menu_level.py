...
def menu_level():
    ...
    level_one_button = Button(image = pygame.image.load("resurs/Play Rect.png"), pos = (500, 200),
                        text_input = "Уровень 1", font = pygame.font.Font("freesansbold.ttf", 65), base_color = view.accent_color,
                        hovering_color = view.game_color)
    arrow_button = Button(image = pygame.image.load("resurs/Arrow.png"), pos = (900, 300),
                        text_input = ">", font = pygame.font.Font("freesansbold.ttf", 70), base_color = view.accent_color,
                        hovering_color = view.game_color)                       
